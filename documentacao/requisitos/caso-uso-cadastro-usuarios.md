...
| 1.2 | Atualização do formato de descrição de telas, e corrigido as tags HTML | Matheus de Azevedo | 10/07/2024 |
...
### FEX01 - Campos obrigatórios não preenchidos
| ID | Passo | Fluxo | Regra de Negócio | Tela |
|:--------------|:----------------|:--------------|:----------------|:--------------|
...
### FEX03 - Nenhum resultado encontrado
| ID | Passo | Fluxo | Regra de Negócio | Tela |
|:--------------|:----------------|:--------------|:----------------|:--------------|
