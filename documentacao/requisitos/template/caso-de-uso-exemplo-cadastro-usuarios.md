...
<a name="tela1"></a>**Tela 1** - `Cadastro de pessoa física - Dados pessoais`
...
| Telefone | x | | Numérico | | | [RI01](#RI) |
| Perfil | x | | Seleção única | | Valores válidos: Pesquisador, Estudante, Inventor Independente, Empreendedor e Representante De Empresa/Instituição | [RI01](#RI) |
| Senha | x | | Alfanumérico | | | [RI01](#RI) |
| Confirmar Senha | x | | Alfanumérico | | | [RI01](#RI), [RI03](#RI) |
| CEP | x | | Alfanumérico | | | [RI01](#RI) |
| Endereço | x | | Alfanumérico | | | [RI01](#RI) |
| Número | x | | Alfanumérico | | | [RI01](#RI) |
| Complemento | | | Alfanumérico | | | |
| Bairro | x | | Alfanumérico | | | [RI01](#RI) |
| Cidade | x | | Alfanumérico | | | [RI01](#RI) |
| Estado | x | | Alfanumérico | | | [RI01](#RI) |
| Definição de vínculo | x | | Seleção única | | Valores válidos: ICT, Empresa, Órgão de governo, Entidade da Sociedade Civil e Pessoa Física. | [RI01](#RI) |
| Banco de Talentos| x | | Seleção única | | Valores válidos: Participar do Banco e Não Participar | [RI01](#RI), [RI04](#RI) |
| Avançar | | | Botão | | | |

<a name="tela2"></a>**Tela 2** - `Mensagem de divulgação dos dados de contato`
...
<a name="tela3"></a>**Tela 3** - `Cadastro de pessoa fisica - Banco de talentos`
...
| Forma de Contato | x | | Seleção múltipla | | Valores válidos: E-mail, Instagram, Twitter, LinkedIn e Facebook |[RI01](#RI)  |
| Profissão ou Habilidade Principal | x | | Alfanumérico | | | [RI01](#RI) |
| Descrição de Habilidades | x | | Alfanumérico | | | [RI01](#RI) |
| Carregar foto | | | Botão | | | |
| Remover foto | | | Botão | | | |
| Cadastrar | | | Botão | | | |
| Voltar | | | Botão | | | |

<a name="tela4"></a>**Tela 4** - `Cadastro de pessoa jurídica - Dados da empresa`
...
|:--------------|:----------------:|:--------------:|:--------------|:----------------|:--------------|:----------------|
| Nome | x | | Alfanumérico | | | [RI01](#RI) |
| CNPJ | x | | Alfanumérico | XX.XXX.XXX/0001-XX | | [RI01](#RI) |
| Site | | | Alfanumérico | | | |
| Telefone | x | | Numérico | | | [RI01](#RI) |
| CEP | x | | Alfanumérico | | | [RI01](#RI) |
| Endereço | x | | Alfanumérico | | | [RI01](#RI) |
...
<a name="tela5"></a>**Tela 5** - `Cadastro com Sucesso`
...
<a name="tela6"></a>**Tela 6** - `As senhas não coincidem`
...
| 2 | O usuário escolhe a opção de vínculo pessoa física | [FA01](#FA) | | [1](#tela1) |
| 3 | O usuário escolhe participar do banco de talentos e pressiona o botão avançar | [FA02](#FA) [FEX02](#FC) | | [1](#tela1) |
| 4 | O sistema exibe mensagem para concordância de divulgação dos contatos pessoais  | [FA02](#FA) | [RN04](#RN) | [2](#tela2) |
| 5 | O usuário pressiona o botão concordar | [FA02](#FA) | [RN05](#RN) | [2](#tela2) |
| 6 | O sistema mostra a página de cadastro do banco de talentos |  | | [3](#tela3) |
| 7 | O usuário insere informações necessárias |  |  | [3](#tela3) |
| 8 | O usuário pressiona o botão cadastrar | [FEX02](#FC)  | | [3](#tela3) |
...
| 2| O usuário pressiona o botão avançar | [FEX01](#FC), [FEX02](#FC), [FEX03](#FC)  | | [1](#tela1) |
...
| 5 | O usuário pressiona o botão cadastrar | [FEX02](#FC)  | | [4](#tela4) |
